...
export const ALL_DESTINATIONS = [
  ...
  { id: 2, pathName: "Jiufen", name: "Jiufen, Taiwan", type: "beach", weather: "tropical", image: KYUFUN_IMAGE },
  { id: 3, pathName: "Manila", name: "Manila, Philippines", type: "beach", weather: "tropical", image: MANILA_IMAGE },
  { id: 4, pathName: "Vancouver", name: "Vancouver, Canada", type: "city", weather: "cold", image: VANCOUVER_IMAGE },
  { id: 5, pathName: "Seattle", name: "Seattle, United States", type: "city", weather: "cold", image: SEATTLE_IMAGE },
  { id: 6, pathName: "Portland", name: "Portland, United States", type: "city", weather: "cold", image: PORTLAND_IMAGE },
